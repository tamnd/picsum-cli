...
func TestHostWiring(t *testing.T) {
	...
	if want := "picsum://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("picsum", "about")
	if err != nil || got.String() != "picsum://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want picsum://page/about", got.String(), err)
	}
}
