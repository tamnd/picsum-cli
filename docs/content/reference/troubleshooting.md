...
Most of these come down to network reality or how picsum serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

picsum rate-limits like any public site. picsum already paces
...
Where a surface is gated, picsum reads a cookie or token you supply
...
`picsum`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what picsum actually did
